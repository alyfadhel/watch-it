...
import 'package:watch_it/features/movies/presentation/widgets/see_all/build_see_all_top_rated.dart';

class SeeAllTopRatedScreen extends StatelessWidget {
  const SeeAllTopRatedScreen({Key? key}) : super(key: key);
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<MoviesCubit, MoviesState>(
        ...
        builder: (context, state) {
          ...
          if(state is GetMoviesTopRatedLoadingState){
